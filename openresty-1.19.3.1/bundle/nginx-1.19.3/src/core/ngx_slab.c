...
ngx_slab_sizes_init(void)
{
    ...
    ngx_slab_max_size = ngx_pagesize / 2; /* 2048 = 4096 / 2 */
    ngx_slab_exact_size = ngx_pagesize / (8 * sizeof(uintptr_t)); /* 64 = 4096 / (8 * 8)*/
    for (n = ngx_slab_exact_size; n >>= 1; ngx_slab_exact_shift++) { /* 左移ngx_slab_exact_shift位，ngx_slab_exact_size=0 */
        /* void */
    }
}
